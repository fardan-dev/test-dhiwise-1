            ...
            VStack {
                VStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack {
                            VStack {
                                Text(StringConstants.kMsgLoginviewcontro)
                                    .font(Font.system(size: getRelativeHeight(20.0)))
                                    .fontWeight(.regular)
                                    .foregroundColor(ColorConstants.Black900)
                                    .minimumScaleFactor(0.5)
                            ...
                            .onTapGesture {
                                appnavigationViewModel.nextScreen = "LoginViewControllerView"
                            }
                            .frame(width: UIScreen.main.bounds.width,
                ...
                Group {
                    NavigationLink(destination: LoginViewControllerView(),
                                   tag: "LoginViewControllerView",
